...
export default function Card(props){
    ...
    return(
        ...
        <div className="card-text">
           <div className="location"><img src="/images/location.png" alt="" className="location-img" /> <span className="location-country">{props.item.location}</span><a href="{props.item.googleMapsUrl}" className="location-maps">view on google maps</a></div>
